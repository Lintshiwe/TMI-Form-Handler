  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#eef4ff" style="background-color:#eef4ff">
    ...
    <tr>
      <td align="center" style="padding:0 16px 40px">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" align="center" style="max-width:420px;margin:-60px auto 0;background:#ffffff;border-radius:24px;border:1px solid #e2e8f0">
          <tr>
